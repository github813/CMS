...
//
  ...
  //  获取货主星级DriverStarById
  ownerStarById(ownerId: number): Observable<any> {
    return this.ajax.getByParams(Api.OwnerStarById, {ownerId:ownerId});
  }
  //修改货主星级
  ownerStarUpdate(ownerId: number,star:number): Observable<any> {
    return this.ajax.put(Api.OwnerStarUpdate+"?star="+star+"&userId="+ownerId, null);
  }
